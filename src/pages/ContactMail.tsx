            ...
            <div className="max-w-2xl mx-auto bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm">
              ...
              <form className="grid grid-cols-1 gap-5">
                <label className="grid gap-2">
                  ...
                  <input className="h-11 rounded-md border border-border px-3 bg-background" placeholder="山田 太郎" />
                </label>
                <label className="grid gap-2">
                  <span className="text-sm font-medium">メールアドレス</span>
                  <input type="email" className="h-11 rounded-md border border-border px-3 bg-background" placeholder="you@example.com" />
                </label>
                <label className="grid gap-2">
                  <span className="text-sm font-medium">ご相談内容</span>
                  <textarea className="min-h-[140px] rounded-md border border-border p-3 bg-background" placeholder="気になる点をご自由にご記載ください" />
                </label>
